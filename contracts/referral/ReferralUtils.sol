...
library ReferralUtils {
    ...
    function setTraderReferralCode(IReferralStorage referralStorage, address account, bytes32 referralCode) internal {
    ...
    function claimAffiliateReward(
        ...
        MarketToken(payable(market)).transferOut(token, receiver, rewardAmount);
