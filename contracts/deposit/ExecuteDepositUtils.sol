...
library ExecuteDepositUtils {
    ...
    function _executeDeposit(
        ...
        // 如果longToken和shortToken price impact factor久始终为0 priceImpactUsd自然也为0
        ...
        if (_params.priceImpactUsd > 0) {
            ...
            MarketUtils.validatePoolAmountForDeposit(params.dataStore, _params.market, _params.tokenOut);

            MarketUtils.validatePoolAmount(params.dataStore, _params.market, _params.tokenOut);
        }
        ...
        MarketUtils.validatePoolAmountForDeposit(params.dataStore, _params.market, _params.tokenIn);
    ...
    function swap(
        ...
        Market.Props[] memory swapPathMarkets = MarketUtils.getSwapPathMarkets(params.dataStore, swapPath);
    ...
    function _validateFirstDeposit(
        ...
        if (initialMarketTokensSupply != 0) {
            return;
        }
