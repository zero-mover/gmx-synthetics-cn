...
library SwapPricingUtils {
    ...
    function getSwapFees(
        ...
        //注意 有可能产生 positive price impact 和  negative price impact 
        //并且 negative price impact 可能大于 positive price impact
        //平衡可能得到改善，但是impact Price还是负面的,这种情况下，将收取 negative price impact 
        //用户可以将订单分成两部分 以产生更少的费用
